...
function roots_scripts() {
  ...
  if (!is_admin() && current_theme_supports('jquery-cdn')) {
    ...
    wp_register_script('jquery', 'http://cdn.jquerytools.org/1.2.7/full/jquery.tools.min.js', false, null, false);
  ...
  wp_register_script('retina', get_template_directory_uri() . '/assets/js/retina.js', false, null, true);
  wp_register_script('masonry', get_template_directory_uri() . '/assets/js/masonry.pkgd.min.js', false, null, true);
  wp_register_script('spritespin', get_template_directory_uri() . '/assets/js/spritespin.js', false, null, true);
